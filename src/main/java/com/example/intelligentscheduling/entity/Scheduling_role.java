...
public class Scheduling_role {
    ...
    public Scheduling_role(String storesId, Integer storesSize, float employeeNeed, Integer beforeTime, Integer beforeEmployeeArea, Integer afterTime, Integer afterEmployeeArea, Integer afterEmployeeMore, float customer_traffic, Integer employeeCount) {
